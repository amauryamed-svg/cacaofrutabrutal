# CAUA Health Report
Timestamp: 2026-04-26T15:15:31Z
Previous run: 2026-04-26T14:15:00Z
...
| Check | Status | Detail |
|-------|--------|--------|
| Site availability | ⚠️ INCONCLUSIVE | 403 `host_not_allowed` — sandbox egress proxy, **0.73s** response time |
...
- Run count: **46th consecutive blocked run** (first blocked: 2026-04-20T22:08:41Z).

---

## Raw curl Evidence

### 2026-04-26T15:15:31Z run (current)
```
# Site availability
403 0.728847s
