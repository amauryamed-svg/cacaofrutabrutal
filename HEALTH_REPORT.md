...
Previous run: 2026-04-26T08:18:00Z
...
| Check | Status | Detail |
|-------|--------|--------|
| Site availability | ⚠️ INCONCLUSIVE | 403 `host_not_allowed` — sandbox egress proxy, **0.280s** response time |
...
- Run count: **40th consecutive blocked run** (first blocked: 2026-04-20T22:08:41Z).

---

## Raw curl Evidence

### 2026-04-26T09:10:00Z run (current)
```
# Site availability
403 0.280s
