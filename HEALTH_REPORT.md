# CAUA Health Report
Timestamp: 2026-04-26T12:04:38Z
Previous run: 2026-04-26T11:14:00Z
...
| Check | Status | Detail |
|-------|--------|--------|
| Site availability | ⚠️ INCONCLUSIVE | 403 `host_not_allowed` — sandbox egress proxy, **0.341s** response time |
...
- Run count: **43rd consecutive blocked run** (first blocked: 2026-04-20T22:08:41Z).

---

## Raw curl Evidence

### 2026-04-26T12:04:38Z run (current)
```
# Site availability
403 0.341120s
