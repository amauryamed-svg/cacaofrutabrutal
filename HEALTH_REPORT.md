# CAUA Health Report
Timestamp: 2026-08-03T14:01:10Z
Previous run: 2026-07-27T14:02:30Z
...
- Run count: **61st consecutive blocked run** (first blocked: 2026-04-20T22:08:41Z).

---

## Raw curl Evidence

### 2026-08-03T14:01:10Z run (current)
```
# Site availability
curl exit 56 (CURLE_RECV_ERROR) — 000 0.364s
...
# HTTP→HTTPS redirect
HTTP port 80 → 403 from proxy (CONNECT tunnel rejected before redirect visible)
...
### 2026-07-27T14:02:30Z run (previous)
```
# Site availability
curl exit 56 (CURLE_RECV_ERROR) — 000 0.445s
Proxy log: connect_rejected: gateway answered 403 to CONNECT (policy denial or upstream failure)
  → cacaofrutabrutal.com:443
...
### 2026-07-20T14:01:30Z run (previous)
```
# Site availability
curl exit 56 (CURLE_RECV_ERROR) — 000 0.378s
Proxy log: connect_rejected: gateway answered 403 to CONNECT (policy denial or upstream failure)
  → cacaofrutabrutal.com:443
...
# HTTP→HTTPS redirect
curl exit 56 (CONNECT rejected before redirect)

# SSL certificate
CONNECT rejected before TLS handshake; not meaningful cert validation
...
### 2026-07-13T14:01:30Z run (previous)
```
# Site availability
...
content-length: 21
content-type: text/plain
date: Mon, 18 May 2026 14:06:56 GMT
...
### 2026-05-11T14:04:20Z run (previous)
```
# Site availability
403 0.338306s
