...
const translations = {
  ...
  land_sub:      { es: 'Adopta un árbol. Sigue su crecimiento. Recibe su cosecha.',
                   en: 'Adopt a tree. Follow its growth. Receive its harvest.' },
  ...
  land_cta1:     { es: 'ADOPTAR UN ÁRBOL', en: 'ADOPT A TREE'    },
  ...
  land_v1_title: { es: 'ADOPTA TU ÁRBOL', en: 'ADOPT YOUR TREE' },
  land_v1_desc:  { es: 'Apadrina un árbol de Cacao Criollo y sigue su evolución desde Semilla hasta Cosecha. Cada árbol tiene un cacaocultivador real y datos climáticos en vivo.',
                   en: 'Sponsor a Criollo Cacao tree and track its evolution from Seed to Harvest. Each tree has a real grower and live climate data.' },
