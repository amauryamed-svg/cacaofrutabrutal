...
const translations = {
  ...
  // ── Landing ────────────────────────────────────────────────────────────────
  land_eyebrow:  { es: 'Cacao Criollo Colombiano · Agroforestería Regenerativa',
                   en: 'Colombian Criollo Cacao · Regenerative Agroforestry' },
  land_sub:      { es: 'Elige tu clase genética. Sigue su crecimiento. Recibe su cosecha.',
  ...
  land_adopt_pitch: {
    es: 'Adopta un árbol GRATIS durante el onboarding mientras optimizamos el flow on-chain. Aprovecha la ventana — pronto: ${PRICE} USD con split 60/30/10 al guardián, cooperativa y protocolo.',
  ...
  land_guardians:{ es: 'CACAOCULTORES', en: 'CACAO GROWERS'  },
  land_join:     { es: 'Tu primer árbol te espera', en: 'Your first tree is waiting' },
  land_scroll:   { es: 'SCROLL',           en: 'SCROLL'          },

  land_v1_title: { es: 'CLASE GENÉTICA', en: 'GENETIC CLASS' },
  land_v1_desc:  { es: 'Selecciona una clase genética de Cacao Criollo y sigue su evolución desde Semilla hasta Cosecha. Cada ecosistema tiene un cacaocultivador real y datos climáticos en vivo.',
                   en: 'Select a Criollo Cacao genetic class and track its evolution from Seed to Harvest. Each ecosystem has a real grower and live climate data.' },
  land_v2_title: { es: 'FINE-FLAVOR DE COLOMBIA', en: 'COLOMBIAN FINE-FLAVOR' },
  land_v2_desc:  { es: 'Cacao Criollo Élite en sistemas agroforestales regenerativos con plátano, mango y forestales nativos. El chocolate más fino del mundo, de origen trazable.',
                   en: 'Elite Criollo Cacao in regenerative agroforestry systems with banana, mango and native trees. The world\'s finest chocolate, fully traceable.' },
  land_v3_title: { es: 'INGRESO DIRECTO AL CAMPO', en: 'DIRECT INCOME TO FARMERS' },
  land_v3_desc:  { es: '+180% ingreso directo a los cacaocultores. Tu adopción financia el cuidado del árbol y la cosecha — y te acerca al primer cacao colombiano en Whole Foods Austin.',
                   en: '+180% direct income to cacao growers. Your adoption funds tree care and harvest — and brings us closer to the first Colombian cacao at Whole Foods Austin.' },
