...
const STATIC_TECHNOLOGIES: Technology[] = [
  ...
  },
  {
    ...
    input_description: '🌱 60 kg baba de cacao fresca · Híbrido acriollado + trinitarios certificados',
    process_steps: [
    ...
    mvps: [
      {
        ...
        description: 'Agua floral destilada de cacao premium · Uso cosmético + alimentario · IaaS B2B',
        sku: 'MVP-HYD-500ML',
        size_label: '500mL',
      ...
      },
      {
        id: 'static-mvp-3b',
        technology_id: 'static-hydrosol',
        name: 'Aceite Esencial de Cacao',
        description: 'Aceite esencial puro de cacao · Aromaterapia · IaaS B2B',
        sku: 'MVP-ACE-5ML',
        size_label: '5mL',
        price_usd_cents: 500,
        price_cop: 20000,
  ...
  },
  {
    ...
    input_description: '🫘 20 kg mucílago de cacao congelado · Híbrido acriollado · Hobo, Huila · Finca Santamaría de Lucho',
    process_steps: [
